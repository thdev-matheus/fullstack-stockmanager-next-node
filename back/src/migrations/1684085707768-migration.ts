...
export class migration1684085707768 implements MigrationInterface {
    name = 'migration1684085707768'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "product" ("id" uuid NOT NULL, "name" character varying(250) NOT NULL, "stock" integer NOT NULL DEFAULT '0', "purchasePrice" double precision NOT NULL, "salePrice" double precision NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "categoryId" uuid, "companyId" character varying NOT NULL, CONSTRAINT "UQ_22cc43e9a74d7498546e9a63e77" UNIQUE ("name"), CONSTRAINT "PK_bebc9158e480b949565b4dc7a82" PRIMARY KEY ("id"))`);
