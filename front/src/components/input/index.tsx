  ...
  ({ label, icon: Icon, error, type, ...rest }, ref) => {
    ...
    return (
      <div className="w-full text-[11pt] text-left ">
        <div className="w-full mb-1 pl-4 text-white font-bold whitespace-nowrap overflow-ellipsis overflow-hidden">
          {label}{" "}
          {!!error && (
            <span
              title={error}
        ...
        <section
          className={`w-full h-[2.5rem] flex items-center p-[.5rem] transition-all bg-[#111112] border-[1px] border-white rounded-[.5rem] px-3 ${
